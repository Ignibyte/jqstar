...
Native links remain the baseline; an explicitly installed Turbo or htmx host owns eligible GET
visits, cancellation and fallback.
...
- [x] [AC-01] Activation links 0023's native-document decision, exact policy/limits/metrics, and a
